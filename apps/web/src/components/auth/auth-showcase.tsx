        ...
        <div className="mx-auto w-full max-w-lg px-8">
          <div className="-translate-y-6">
            ...
            <p className="mt-5 max-w-md text-lg leading-7 text-muted-foreground">
              {isSignIn ? (
                <>
                  Pick up where you left off. Keep your projects,
                  <br />
                  tasks, and team moving forward.
                </>
              ) : (
                <>
                  Plan projects, collaborate with your team,
                  <br />
            ...
            <div className="relative mt-10 h-64">
              {/* Card 1 */}
              <Card className="absolute left-0 top-0 w-[420px] gap-0 overflow-hidden rounded-xl border border-border bg-card py-0 shadow-lg">
                <CardContent className="p-5 ">
                  ...
                  {/* Task title */}
                  <p className=" text-[15px] font-semibold tracking-tight text-card-foreground">
              ...
              {/* Card 2 */}
              <Card className="absolute left-20 top-36 z-10 w-[420px] gap-0 overflow-hidden rounded-xl border border-border bg-card py-0 shadow-xl">
                <CardContent className="p-5">
                  {/* Top row */}
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex min-w-0 items-center gap-3">
