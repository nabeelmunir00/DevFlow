  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: cn(
          ["absolute inset-0", "bg-popover opacity-0"].join(" "),
        ...
        week_number: cn(
          ["text-xs", "text-muted-foreground", "select-none"].join(" "),
    ...
    <Button
      ...
      className={cn(
        [
          ...
          "group-data-[focused=true]/day:ring-offset-2",
          "group-data-[focused=true]/day:ring-offset-background",
